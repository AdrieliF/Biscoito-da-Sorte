...
const btn1 = screen1.querySelector("button")
const btn2 = screen2.querySelector("button")
...
btn1.addEventListener('click', generatePhrase)
...
function generatePhrase() {
  ...
  screen2.querySelector("p").innerText = phrases[generateRandomPhrases]
}
